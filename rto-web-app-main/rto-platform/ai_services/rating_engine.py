...
class TASRatingEngine:
    ...
    def calculate_reward(
        ...
        components = {
            ...
            'sentiment': self.weights['sentiment'] * sentiment_score,
    ...
    def categorize_broker(self, rating: float) -> str:
        """Backward compatible alias for categorize_rating"""
        return self.categorize_rating(rating)
